...
class Popup extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        // 检查 popup 是否从“隐藏”变为“显示”
        if (
            prevProps.style.display !== 'flex' &&
            this.props.style.display === 'flex'
        ) {
            this.setState({
                text: 'You have completed the quiz. <br /> You got: <strong>' +
                    this.props.score + '</strong> out of <strong>' +
                    this.props.total + '</strong> questions right.'
            });
        }
    }
